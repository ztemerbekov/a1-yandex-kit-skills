...
- `a1-yandex-kit-setup` — подключает MCP к пользовательскому конфигу Claude Code, Claude Desktop, Cursor, Codex, VS Code, Kimi Code, Kimi Desktop, Hermes Agent или OpenClaw; для других клиентов находит актуальный формат по официальной документации, а после установки проверяет `get_store`.
...
Поддерживаются Claude Code, Claude Desktop, Cursor, OpenAI Codex, VS Code, Kimi Code, Kimi Desktop, Hermes Agent и OpenClaw. Для другого клиента скилл сначала проверит актуальную официальную документацию; если безопасно изменить конфиг автоматически нельзя, он подготовит один технический handoff без токена.
