...
> **Вы:** Чё, как дела?
>
> **Ассистент:** Проверил магазин: заказов нет, опубликовано 11 SKU, ещё один товар скрыт. Обнаружил два риска: публичная витрина отвечает 404, а у скрытого кроп-топа по-прежнему числится остаток 13 штук.
>
