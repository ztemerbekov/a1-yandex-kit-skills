...
- **Голосом или текстом.** Не нужно подбирать специальные команды: формулируйте рабочие задачи естественным языком — пишите или диктуйте, если приложение поддерживает голосовой ввод.
