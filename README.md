...
- `a1-yandex-kit-catalog-doctor` — полный read-only аудит опубликованных и скрытых SKU, продуктов, категорий и используемых складов со счётчиками покрытия и разделением на блокеры, риски и рекомендации.
