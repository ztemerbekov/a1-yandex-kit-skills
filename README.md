...
- **Надёжная база** — типизированный клиент, 236 юнит-тестов без сети, CI на Node 20/22/24, сгенерированный код проверяется на дрейф.
